...
SBomber::SBomber()
    ...
    score(0)
{
    LoggerSingleton::geg().WriteToLog(string(__FUNCTION__) + " was invoked");
...
void SBomber::ProcessKBHit()
{
    ...
    LoggerSingleton::geg().WriteToLog(string(__FUNCTION__) + " was invoked. key = ", c);
...
void SBomber::TimeFinish()
{
    ...
    LoggerSingleton::geg().WriteToLog(string(__FUNCTION__) + " deltaTime = ", (int)deltaTime);
}
